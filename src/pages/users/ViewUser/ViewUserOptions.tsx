      ...
      if (controlType === "file") {
        displayValue = (
          <img
            ...
            onError={(e) => {
              e.currentTarget.src =
                "https://static.vecteezy.com/system/resources/previews/000/439/863/original/vector-users-icon.jpg"; // Set default image on error
            }}
          />
        );
      ...
      rows.push(
        name === "image" ? (
          ...
          <div className="d-flex  " key={name}>
            <strong className="d-block mx-3 ">
              {label !== "profile image" ? label : undefined}{" "}
            </strong>{" "}
            {displayValue}
          </div>
        )
